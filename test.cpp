...
int main(){
    ...
    using namespace x86;
    std::size_t offs = InstructionEncoding<prefix<0x66_b>, opcode_nr<0x81_b>, modrm<0_b>, immediate<width::WORD>>::encode(buf, 0x01_b /* [...]+disp8 */ , 0_b /* A register */, displacement<width::W8>{5}, skip_immediate).offset_of_first<x86::pred_is_immediate>;
